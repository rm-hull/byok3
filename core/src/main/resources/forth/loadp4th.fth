...
include? >number            forth/numberio.fth
include? task-misc1.fth     forth/misc1.fth
include? case               forth/case.fth
include? $=                 forth/strings.fth
include? privatize          forth/private.fth
include? (local)            forth/ansilocs.fth
include? {                  forth/locals.fth
